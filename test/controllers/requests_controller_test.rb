...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { request_duty_id: @request.request_duty_id } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { request_duty_id: @request.request_duty_id } }
